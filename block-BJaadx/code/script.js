...
let ulchild = document.body.children[5];
console.log(ulchild.children.length);
...
firstLi = document.querySelector('ul>li');
...
console.log(`The total number of img element is ${document.
