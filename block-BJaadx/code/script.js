...
document.body.children[0].innerText = "Learnig DOM";
//    - Select the first `li` element inside the `ul` with class `topics` and change the innerText to `all about document`
document.body.children[5].children[0].innerText = `all about document`;

//    - Select the input element with name `email`
document.body.children[6].children[1].innerText = 'email';
// 3. Log the number (using console.log) of children of all the `li` element inside the ul with class `topics`
console.log(document.body.children[5].children[0].innerText);
...
let attrPassword = document.querySelector('#password');
// 10. Select all the `li` element and store in `allTopics`
let allTopics = document.querySelectorAll('li');
// 11. Select all the input element of any type and store in `allInput`
let allInput = document.querySelectorAll('input');
// // 12. Use forEach to console the `innerText` property of all the li element in `allTopics` variable.
console.log(allTopics.forEach((li) => li.innerText));
...
console.log(`The total number of img element is ${document.querySelectorAll('p').length}`);
// 17. Select all the buttons and log the count of buttons.
console.log(`The total number of img element is ${document.querySelectorAll('button').length}`);
// 18. Select all the `label` element and log the count.
console.log(`The total number of img element is ${document.querySelectorAll('label').length}`);
// 19. Select all the elements with `id` of `test`
console.log(`The total number of img element is ${document.querySelectorAll('#test').length}`);
